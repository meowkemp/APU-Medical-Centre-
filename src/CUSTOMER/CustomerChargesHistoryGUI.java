 ...
 * @author kjeya
 */
public class CustomerChargesHistoryGUI extends javax.swing.JFrame {
    private UserManager userManager;
    private DefaultTableModel model = new DefaultTableModel();
    private String[] columnName = {"Charge ID","Customer ID", "Appointment ID", "Amount(RM)", "Description", "Payment Status", "Doctor ID"};
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(CustomerChargesHistoryGUI.class.getName());

    /**
     * Creates new form CustomerChargesHistoryGUI
     */
    public CustomerChargesHistoryGUI(UserManager userManager) {
        initComponents();
        ...
        model = history.viewChargeHistory(columnName, customerId);
        jtCharges.setModel(model);
    }
    
    public CustomerChargesHistoryGUI(){
        this(null);
    }
    ...
    private void initComponents() {
        ...
        jtCharges = new javax.swing.JTable();
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(btnBookApp1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            .addComponent(btnCheckApp, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jLabel1.setText("View Charges History");

        jtCharges.setModel(model);
        jScrollPane1.setViewportView(jtCharges);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new CustomerChargesHistoryGUI().setVisible(true));
    }
    ...
    private javax.swing.JTable jtCharges;
