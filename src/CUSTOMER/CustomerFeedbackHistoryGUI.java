 ...
 * @author kjeya
 */
public class CustomerFeedbackHistoryGUI extends javax.swing.JFrame {
    private UserManager userManager;
    private DefaultTableModel model = new DefaultTableModel();
    private String[] columnName = {"Feedback ID", "Doctor ID","Customer ID","Appointment ID", "Date&Time", "Notes"};
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(CustomerFeedbackHistoryGUI.class.getName());

    /**
     * Creates new form CustomerFeedbackHistoryGUI
     */
    public CustomerFeedbackHistoryGUI(UserManager userManager) {
        initComponents();
        ...
        model = history.viewFeedbackHistory(columnName, customerId);
        jtFeedback.setModel(model);
    }
    
    public CustomerFeedbackHistoryGUI(){
        this(null);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("View Doctor Feedback History");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new CustomerFeedbackHistoryGUI().setVisible(true));
    }
