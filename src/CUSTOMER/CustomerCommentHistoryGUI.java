 ...
 * @author kjeya
 */
public class CustomerCommentHistoryGUI extends javax.swing.JFrame {
    private UserManager userManager;
    private DefaultTableModel model = new DefaultTableModel();
    private String[] columnName = {"Comment ID", "Customer ID", "Recipient ID", "Appointment ID", "Date & Time", "Comment"};
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(CustomerCommentHistoryGUI.class.getName());

    /**
     * Creates new form CustomerCommentHistory
     */
    public CustomerCommentHistoryGUI(UserManager userManager) {
        initComponents();
        ...
        model = history.viewCommentHistory(columnName, customerId);
        jtComment.setModel(model);
    }
    
    public CustomerCommentHistoryGUI(){
        this(null);
    }
    ...
    private void initComponents() {
        ...
        jtComment = new javax.swing.JTable();
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(btnBookApp1, javax.swing.GroupLayout.DEFAULT_SIZE, 195, Short.MAX_VALUE)
        ...
        jLabel1.setText("View Comment History");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new CustomerCommentHistoryGUI().setVisible(true));
    }
    ...
    private javax.swing.JTable jtComment;
